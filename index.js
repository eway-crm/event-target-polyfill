/**
 * Forked from 'event-target-polyfill' library, but updated checking if EventTarget is constructor.
 */
...
function isConstructor(fn, param) {
    try {
        if (param) {
            new fn(param);
        } else {
...
if (typeof root.Event !== "function" || !isConstructor(root.Event, "TestEvent")) {
    root.Event = (function () {
...
if (typeof root.EventTarget === "undefined" || !isConstructor(root.EventTarget) || !isConstructor(root.Event, "TestEvent")) {
